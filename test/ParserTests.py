...
class ParserTests (unittest.TestCase):
    ...
    def test_slackware_leet_rc3_entry(self):
        ...
        self.assertEqual(e.description, u"""There have been quite a few changes so we will have one more release
...
""")
        ...
        self.assertEqual(e.pkgs[0].pkg, u'a/aaa_base-13.37-i486-3.txz')
        # There are a few non-typical entries at the end
        self.assertEqual(e.pkgs[57].pkg, u'extra/linux-2.6.37.5-nosmp-sdk/*')
        self.assertEqual(e.pkgs[58].pkg, u'isolinux/initrd.img')
        self.assertEqual(e.pkgs[59].pkg, u'kernels/*')
        self.assertEqual(e.pkgs[60].pkg, u'usb-and-pxe-installers/usbboot.img')
        self.assertEqual(e.pkgs[61].pkg, u'testing/source/linux-2.6.38.1-configs/')
